/// Visual tuning specific to the linked_list phase (Boss Vagoneiro): the
/// gothic-cave backdrop, lanterns, wagons, chains, the boss's eyes, rim
/// light and dock, and the RemoverNo/InserirNo telegraphs.
///
/// Split out of the Módulo 12-15 `fx_config.dart` without changing any
/// value; generic tuning is in `shared/fx/fx_config.dart`. **Nothing here
/// feeds physics, collision, scale or state-machine logic.**
library;
...
// ---------------------------------------------------------------------------
// Asset paths (relative to `Flame.images.prefix`).
// ---------------------------------------------------------------------------
...
const String backgroundLayerFarAssetPath = '${linkedListAssetRoot}background/layer-far.png';
...
const String backgroundLayerMidAssetPath = '${linkedListAssetRoot}background/layer-mid.png';

/// 6-frame 32x32 spritesheet (sheet is 192x32).
const String fxSparkEmberAssetPath = '${linkedListAssetRoot}effects/particles/spark-ember.png';

/// 6-frame 48x64 spritesheet (sheet is 288x64), baseline-aligned.
const String fxSmokeWispAssetPath = '${linkedListAssetRoot}effects/particles/smoke-wisp.png';

// ---------------------------------------------------------------------------
// Render order (phase layers, between the shared ones).
// ---------------------------------------------------------------------------
...
/// Screen shake fired when a wagon enters `falling` — the shared default.
const double wagonFallShakeAmplitude = cameraShakeAmplitude;
const double wagonFallShakeDuration = cameraShakeDuration;
...
const String bossDockAssetPath = '${linkedListAssetRoot}boss/doca.png';
...
const double empurraoPlayerTweenDuration = playerShoveTweenDuration;
...
const double empurraoLandSquashFactor = playerShoveLandSquashFactor;
...
const double empurraoLandSquashDuration = playerShoveLandSquashDuration;
