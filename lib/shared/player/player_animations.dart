...
class PlayerSheetSpec {
  /// File stem; the assets are `shared/player/spritesheets/<stem>_west.png` and
  ...
  String assetPath(PlayerFacing facing) {
    ...
    return stem.isEmpty
        ? 'shared/player/spritesheets/$side.png'
        : 'shared/player/spritesheets/${stem}_$side.png';
  }
...
// ---------------------------------------------------------------------------
// Effects (assets/shared/player/effects/particles/)
// ---------------------------------------------------------------------------

/// 6 frames of 64x32 in one row.
String playerDashTrailAssetPath(PlayerFacing facing) =>
    facing == PlayerFacing.west
        ? 'shared/player/effects/particles/dash-trail-west.png'
        : 'shared/player/effects/particles/dash-trail-east.png';
...
const String playerDoubleJumpBurstAssetPath =
    'shared/player/effects/particles/double-jump-east.png';
...
String playerSlashArcAssetPath(PlayerFacing facing) =>
    facing == PlayerFacing.west
        ? 'shared/player/effects/particles/sword-slash-arc.png'
        : 'shared/player/effects/particles/sword-slash-arc-east.png';
