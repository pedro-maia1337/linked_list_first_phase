...
class SkyFill extends Component {
  ...
  SkyFill({required this.camera, Color color = parallaxSkyFillColor})
...
class ParallaxLayer extends Component {
  ...
  /// edge, from [parallaxSkyFillColor] fully opaque at the edge down to
  ...
  void _renderTopFade(Canvas canvas, Rect visible, double top) {
    ...
    // the identical [parallaxSkyFillColor] from [SkyFill], so overshooting
