...
class SpriteBurst extends SpriteAnimationComponent {
  ...
  static Future<SpriteBurst> sparkEmber(Vector2 position) async {
    final animation = await ParticleSheets.animation(
  ...
  static Future<SpriteBurst> smokeWisp(
    Vector2 position, {
...
class SpriteLoop extends SpriteAnimationComponent {
  ...
  static Future<SpriteLoop> sparkEmber(Vector2 position) async {
    final animation = await ParticleSheets.animation(
      fxSparkEmberAssetPath,
      stepTime: sparkEmberStepTime,
      loop: true,
