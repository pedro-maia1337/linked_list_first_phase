...
const VagaoFrame vagaoIdleFrame =
    VagaoFrame('wagons/states/frame_01_idle.png', 49.5);
...
const List<VagaoFrame> vagaoTremorFrames = [
  VagaoFrame('wagons/states/frame_02_tremor1.png', 73.5),
  VagaoFrame('wagons/states/frame_03_tremor2.png', 21.5),
  VagaoFrame('wagons/states/frame_04_tremor3.png', -4.0),
  VagaoFrame('wagons/states/frame_05_tremor4.png', -41.0),
];
...
const List<VagaoFrame> vagaoFallingFrames = [
  ...
  VagaoFrame('wagons/states/frame_06_break1.png', 51.0),
  VagaoFrame('wagons/states/frame_07_break2.png', 70.5),
  // elo já solto / pendurado
  VagaoFrame('wagons/states/frame_08_link_detached1.png', 23.5),
  VagaoFrame('wagons/states/frame_09_link_detached2.png', -4.0),
  // caindo / girando
  VagaoFrame('wagons/states/frame_10_falling1.png', -29.5),
  VagaoFrame('wagons/states/frame_11_falling2.png', 43.0),
  VagaoFrame('wagons/states/frame_12_falling3.png', 0.0),
  // impacto final
  VagaoFrame('wagons/states/frame_13_impact1.png', -13.5),
  VagaoFrame('wagons/states/frame_14_impact2.png', 18.0),
  VagaoFrame('wagons/states/frame_15_final.png', -31.5),
];

/// Convenience alias kept for the `spawning` mapping in section 8.1 ("sem
/// sprite dedicado — o asset de idle com fade-in/pop").
const String vagaoIdleAssetPath = 'wagons/states/frame_01_idle.png';
...
/// scaled down with it).
class Vagao extends PositionComponent {
