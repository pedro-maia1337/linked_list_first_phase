...
/// Player hit points. Every source of combat damage costs exactly 1 (see
/// the constants below), so this is also "how many mistakes the fight
/// forgives".
...
/// Kept as a player capability (and exercised by the debug harness) now
/// that the attack that used to spend it is gone.
