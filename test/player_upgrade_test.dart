...
import 'package:linked_list_first_phase/game/boss/boss_combat.dart';
import 'package:linked_list_first_phase/game/boss/vagoneiro_boss.dart';
import 'package:linked_list_first_phase/game/player/arena_wall.dart';
import 'package:linked_list_first_phase/game/player/player.dart';
import 'package:linked_list_first_phase/game/player/player_fx.dart';
...
void main() {
  ...
  group('Frente 1 — spritesheets', () {
    ...
    test('no north/south anywhere: no asset, no state, no code', () {
      final names = Directory('assets/player')
  ...
  group('Frente 1 — idle replaces the frozen walk frame', () {
    test('the freeze code is gone from the player', () {
      final src = File('lib/game/player/player.dart').readAsStringSync();
